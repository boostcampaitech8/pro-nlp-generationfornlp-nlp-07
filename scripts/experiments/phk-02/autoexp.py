...
from src.models.model_loader import load_model_unsloth, load_checkpoint_unsloth
# from src.models.lora_config import get_lora_config # Unsloth uses internal config handling
...
def main():
    ...
    trainer = create_trainer(
        ...
        peft_config=None, # Unsloth handles PEFT internally
    ...
    model, tokenizer = load_checkpoint_unsloth(
        str(checkpoint_path),
        max_seq_length=MAX_TOKEN_LENGTH,
        device_map="cuda",
        dtype=torch.float16,
