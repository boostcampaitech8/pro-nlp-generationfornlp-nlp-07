...
export EXP_NAME="Qwen3-32B-bnb-4bit-CoT_2.1"
...
export TRAIN_BASE_MODEL="${OUTPUT_ROOT}/T8164/Qwen3-32B-bnb-4bit-CoT_2/best_model"

# (2) 추론용 '진짜' 베이스
export INFER_BASE_MODEL="unsloth/Qwen3-32B-bnb-4bit"
