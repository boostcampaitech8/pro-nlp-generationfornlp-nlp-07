...
export EXP_NAME="Qwen2.5-32B-Instruct-bnb-4bit_6"
...
export ANSWER_ONLY_LOSS=1 # ver6
...
export LORA_DROPOUT=0.00
export COT_KEEP_PROB=1.0 ## ver5
...
nohup python3 -u train_cot_answer_only.py > "${TRAIN_LOG}" 2>&1
