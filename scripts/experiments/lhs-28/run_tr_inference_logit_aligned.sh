...
export EXP_NAME="Qwen2.5-32B_fixed_ver1"
...
export USE_CHAT_TEMPLATE=1        # 기본 1 (학습과 맞춤)
export MAX_SEQ_LENGTH=4096        # 기본 4096
export TRUNCATION_SIDE=left       # 기본 left (끝부분 보존)
...
export PRIOR_ALPHA=0.8
export PRIOR_TRAIN_PATH="/data/ephemeral/home/pro-nlp-generationfornlp-nlp-07/data/train/train.csv"
export LOGIT_TEMPERATURE=1.2
...
nohup python3 -u inference_logit_sc_aligned.py > "${INFER_LOG}" 2>&1 &
