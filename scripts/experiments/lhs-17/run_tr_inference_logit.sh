...
export EXP_NAME="Qwen2.5-32B-Instruct-bnb-4bit_noCoT"
...
# ===== CoT 학습 on/off =====
export USE_COT_TRAIN=0
export COT_TRAIN_PATH="/data/ephemeral/home/pro-nlp-generationfornlp-nlp-07/data/train/train.csv"
